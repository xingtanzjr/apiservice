...
import (
	...
	scheme "multitenancy.metricsadvisor.ai/apiservice/generated/multitenancy/clientset/versioned/scheme"
)
...
func newApiServices(c *MultitenancyV1Client, namespace string) *apiServices {
	return &apiServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
